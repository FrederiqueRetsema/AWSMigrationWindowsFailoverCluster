$SourceDirectory                  = "D:\Clone\AMIS-unpublished\AWSMigration\FailoverCluster\LambdaFunctions"
$ZipDirectory                     = "D:\Clone\AMIS-unpublished\AWSMigration\FailoverCluster\LambdaFunctions\Zips"
