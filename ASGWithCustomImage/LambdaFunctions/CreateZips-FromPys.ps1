...
Create-ZipFileWithLibrary    -PythonFile "${SourceDirectory}\PutParameter.py"                  -ZipFile "${ZIPDIRECTORY}\PutParameter.zip"              -Library requests -TempDirectory $TEMPDIRECTORY
Create-ZipFileWithLibrary    -PythonFile "${SourceDirectory}\CreateImage.py"                   -ZipFile "${ZIPDIRECTORY}\CreateImage.zip"               -Library requests -TempDirectory $TEMPDIRECTORY
Create-ZipFileWithLibrary    -PythonFile "${SourceDirectory}\UpdateASGConfiguration.py"        -ZipFile "${ZIPDIRECTORY}\UpdateASGConfiguration.py.zip" -Library requests -TempDirectory $TEMPDIRECTORY
