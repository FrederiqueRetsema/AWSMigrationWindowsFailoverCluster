$SourceDirectory                  = "D:\Clone\AMIS-unpublished\AWSMigration\ASGWithCustomImage\LambdaFunctions"
$ZipDirectory                     = "D:\Clone\AMIS-unpublished\AWSMigration\ASGWithCustomImage\LambdaFunctions\Zip"
